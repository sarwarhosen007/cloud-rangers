  ...
  return (
    <>
      ...
      <Section className="pt-0">
        <ol className="relative border-l border-border/80 pl-8">
          {STEPS.map((s, i) => {
            const Icon = s.icon;
            return (
              <li key={s.title} className="relative pb-10 last:pb-0">
                <span className="absolute -left-[42px] top-0 grid h-10 w-10 place-items-center rounded-full border border-border bg-background ring-4 ring-background">
